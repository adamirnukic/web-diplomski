...
export const GAMES: GameMeta[] = [
  ...
  },
  {
    id: 'coup',
    name: 'Coup',
    description: 'Blef i dedukcija — uticaj, izazovi i blokade. 2-6 igrača, botovi.',
    category: 'cards',
    minPlayers: 2,
    maxPlayers: 6,
    icon: Swords,
  ...
  },
  {
    id: 'six-nimmt',
    name: '6 Nimmt!',
    description: 'Izbjegni volovske glave — istovremeno biraj kartu i pazi na 6. u redu. 2-6, botovi.',
    category: 'cards',
    minPlayers: 2,
    maxPlayers: 6,
    icon: Layers,
